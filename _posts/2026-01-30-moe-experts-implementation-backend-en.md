...
![Batched Matrix Multiplication (bmm) vs Grouped GEMM Approach](/assets/img/experts_impl_blog_1.png)
*Batched Matrix Multiplication (bmm) vs Grouped GEMM Approach*
...
![Solar-Open 100B Latency Comparison (Experts Backend & Torch Compile)](/assets/img/solar_latency_summary.png)
*Solar-Open 100B Latency Comparison (Experts Backend & Torch Compile)*
